...
<html>
  ...
  <body>
 	 ...
 	 <h1>Lab 8 Demo 1: JavaScript RSA test</h1>
         ...
         Enter a plaintext: <input id="plaintext" name="plaintext" type="text" value="upload/loading.PNG">
	<br/><br/>
	...
	function RSA_decryption(){
        ...
        var decrypted = decrypt.decrypt(encrypted);
		  document.getElementById("img_Image").src = decrypted;
