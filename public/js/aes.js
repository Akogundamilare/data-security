...
var keyCall;
var ciphertext;
Aes.Ctr.encryptKey  = function(){    
    return keyCall;
}

Aes.Ctr.encryptCipherText  = function(){    
    return ciphertext;
}
...
//   alert(Base64.encode(ciphertxt.join('')));
   $('#ensKey').html(Base64.encode(ciphertxt.join('')));
   Aes.Ctr.encryptKey(Base64.encode(ciphertxt.join('')));
